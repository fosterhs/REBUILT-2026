...
public class Intake { 
  ...
  public void updateDash() {
    ...
    if (Robot.isSimulation()) SmartDashboard.putString("Intake Mode", currMode.toString());
  }
  ...
  private void configArmMotor(TalonFX motor, CANcoder encoder, boolean invert) {
    ...
    motorConfigs.MotionMagic.MotionMagicAcceleration = 1.4*5800.0/(60.0*18.75); // Units: rotations per second per second.
