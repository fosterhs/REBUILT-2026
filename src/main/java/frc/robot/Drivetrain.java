...
class Drivetrain {
  ...
  private final SwerveModule frontLeftModule = new SwerveModule(1, 2, 1, false, 0.305420, "canivore"); 
  private final SwerveModule frontRightModule = new SwerveModule(3, 4, 2, true, 0.296143 , "canivore");
  private final SwerveModule backRightModule = new SwerveModule(5, 6, 3, true, 0.480713 , "canivore");
  private final SwerveModule backLeftModule = new SwerveModule(7, 8, 4, false, -0.362305, "canivore");
