...
public class IntakeV2 { 
  ...
  public IntakeV2() {
    ...
    configArmMotor(rightArmMotor, leftArmEncoder, false);
    ...
    configArmEncoder(leftArmEncoder, 0.0, false);
    configArmEncoder(rightArmEncoder, 0.0, false);
    leftArmPosition = leftArmEncoder.getPosition();
    rightArmPosition = rightArmEncoder.getPosition();
  ...
  private void configArmEncoder(CANcoder encoder, double offset, boolean invert) {
    ...
    sensorConfigs.MagnetSensor.SensorDirection = invert ? SensorDirectionValue.CounterClockwise_Positive : SensorDirectionValue.Clockwise_Positive; // The direction that the sensor counts as positive. This should be set based on the physical configuration of the encoder on our robot.
